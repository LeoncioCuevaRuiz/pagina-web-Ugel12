...
<body data-spy="scroll" data-target="#navbar-example">
        ...
        <ul>
          <li class="drop-down"><a href="index.php" class="icon-home">UGEL12</a>
            <ul>
              ...
              <li><a href="InstitucionEducativas.html">Instituciones Educativas</a></li>
  ...
  <main id="main">
    ...
    <nav class="lista-menu">
      ...
      <ul><li><a href="InstitucionEducativas.html">Instituciones Educativas</a></li></ul>
      <ul><li><a href="directorio.html">Directorios</a></li></ul>
    </nav>
      </div>
      <div class="columna2">
      ...
      <div class="contenido">
       ...
       <div class="organigrama">
        <h3 class="organigrama-titulo">Organigrama</h3>

        <div class="image-wrap">
          <div class="image"></div>
         </div>
        
      <!--embed class="pdf" src="assets/img/ORGANIGRAMA.pdf" type="application/pdf" width="100%" height="600px" />-->  
        
       </div>

    
       <h3 class="organigrama-titulo2">Organigrama</h3>
       <div class="card">
        ...
        <div class="card-contenido">
          <div class="info-personal desplazar">Organigrama de la Institucion</div>
          <div class="info-personal desplazar">
            <p>Visualizar el organigrama</p>
          </div>
        ...
        <div class="card-acciones">
          <button class="botones agrandar">
            <span><i class="fas fa-download"></i>
              <a href="" class="link" target="_blank"> Ver Organigrama</a>
            </span>
          </button>
        </div>
      </div>
